...
import Sparkles from './animatedSparkles';
...
export default function TabItem(
          ...
          >
            <div className='absolute flex transition ease-out duration-500 right-4 justify-between rounded-lg'>
              <a
                ...
                className='px-[6px] py-1 shadow-sm bg-white hover:bg-gray-100 border-r border-gray-300 border opacity-100 sm:opacity-0 group-hover:opacity-100 rounded-l-lg focus:opacity-100 z-20'
              >
                <GithubIcon />
              </a>
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                className='px-[6px] py-1 shadow-sm bg-white hover:bg-gray-100 border-r border-gray-300 border opacity-100 sm:opacity-0 group-hover:opacity-100 rounded-r-lg focus:opacity-100 z-20'
              >
                <ExternalLink />
              </a>
            </div>
            <Sparkles>
              <h3 className='mt-12 mb-2 text-lg font-medium w-fit'>
                {item.title}
              </h3>
            </Sparkles>
  ...
  return (
    <table className='min-w-[650px] table-auto w-full border-collapse border-y border-spacing-2 border-gray-300 text-sm md:text-base mb-4'>
      ...
      <tbody>
        {projectSection.gridProject.map((item: Project) => (
          <tr key={item.cardId} className='border-b border-gray-300'>
