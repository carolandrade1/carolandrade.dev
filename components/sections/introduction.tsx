...
const introductionSection: Introduction = data.introductionSection;
  ...
  return (
    <section className="mb-16 md:mb-28">
        ...
        <div>
            <h1 className="leading-8 text-3xl md:text-5xl font-bold dark:text-white">{introductionSection.h1}</h1>
            ...
            <div className="flex flex-col mb-6 md:mb-8 md:flex-row md:items-start">
                ...
                <p className="dark:text-gray-300">{introductionSection.description}</p>
            </div>
            <div className="flex flex-col md:flex-row md:items-start">
                ...
                <div className="flex flex-wrap gap-4">
                    {introductionSection.contact.map((item: Contacts) => {
                        return (
                            <ButtonBg key={item.contactId} href={item.url} color={ButtonColor.default} text={item.name} />
                            )   
                        }
                    )}
                </div>
